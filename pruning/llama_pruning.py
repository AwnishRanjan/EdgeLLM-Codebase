...
@torch.no_grad()
def llama_sequential(model, dataloader, dev, nsamples, layer_pruning_ratios, logger, pruning_scheme, seqlen=2048):
        ...
        for names in sequential:
            ...
            for j in range(nsamples):
                position_ids = torch.arange(
                    0, seqlen, dtype=torch.long, device=inps[j].device
                )
