...
# Try to import internal modules, set defaults if not available
try:
    from transformers.trainer import DEFAULT_CALLBACKS, DEFAULT_PROGRESS_CALLBACK, TRAINING_ARGS_NAME, TRAINER_STATE_NAME, OPTIMIZER_NAME, SCHEDULER_NAME, SCALER_NAME
...
try:
    ...
    from transformers.data_collator import DataCollator, DataCollatorWithPadding, default_data_collator
...
try:
    ...
    def default_hp_search_backend(): return None

try:
    from transformers.integrations.deepspeed import deepspeed_init, deepspeed_load_checkpoint, is_deepspeed_available
except ImportError:
    def deepspeed_init(): return None
    def deepspeed_load_checkpoint(): return None
...
try:
    ...
    def load_sharded_checkpoint(): return None
...
try:
    ...
    def is_torch_less_than_1_11(): return False
...
try:
    ...
    IterableDatasetShard = None
    LabelSmoother = None
    LengthGroupedSampler = None
    SequentialDistributedSampler = None
    def distributed_broadcast_scalars(): pass
    def distributed_concat(): pass
    def find_batch_size(): pass
    def get_dataloader_sampler(): pass
    def get_model_param_count(): pass
    def get_module_class_from_name(): pass
    def get_parameter_names(): pass
    def nested_concat(): pass
    def nested_detach(): pass
    def nested_numpify(): pass
    def nested_xla_mesh_reduce(): pass
    def reissue_pt_warnings(): pass
    def remove_dummy_checkpoint(): pass
...
try:
    ...
    EvalLoopOutput = None
    FSDPOption = None
    HPSearchBackend = None
    HubStrategy = None
    IntervalStrategy = None
    RemoveColumnsCollator = None
    TrainerMemoryTracker = None
    TrainOutput = None
    def default_compute_objective(): pass
    def denumpify_detensorize(): pass
    def enable_full_determinism(): pass
    def find_executable_batch_size(): pass
    def get_last_checkpoint(): pass
    def has_length(): pass
    def number_of_arguments(): pass
    def seed_worker(): pass
    def set_seed(): pass
    def speed_metrics(): pass
...
try:
    ...
    def get_reporting_integration_callbacks(): return []
    hp_params = None
...
try:
    ...
    PushInProgress = None
    def can_return_loss(*args, **kwargs): return False
    def find_labels(*args, **kwargs): return None
    ...
    def is_torch_compile_available(): return False
    def is_torch_neuroncore_available(): return False
    def is_torch_tpu_available(*args, **kwargs): return False
    def strtobool(val): return bool(val)
...
try:
    ...
    def _get_learning_rate(): pass
    def log_metrics(): pass
    def metrics_format(): pass
    def save_metrics(): pass
    def save_state(): pass
if is_in_notebook():
